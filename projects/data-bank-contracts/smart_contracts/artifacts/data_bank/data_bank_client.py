...
class DataBankClient:
    """A class for interacting with the DataBank app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        DataBankClient can be created with an app_id to interact with an existing application, alternatively
